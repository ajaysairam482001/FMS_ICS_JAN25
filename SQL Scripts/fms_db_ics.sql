...
CREATE TABLE DocumentVerification (
    ...
    UserID INT NOT NULL FOREIGN KEY REFERENCES Users(UserID),
    --DocumentType NVARCHAR(50) NOT NULL, --this column is removed
	--DocumentLink column is added
...
INSERT INTO DocumentVerification (UserID,DocumentStatus, Remarks)
VALUES
(1, 'Approved', 'Valid ID provided'),
(2,  'Pending', 'Waiting for admin review'),
(3,  'Rejected', 'Insufficient details'),
(4,  'Approved', 'Verified successfully'),
(5,  'Pending', 'Verification in progress'),
(6, 'Approved', 'All documents valid');
...
--ALTER TABLE DocumentVerification
--ADD DocumentLink NVARCHAR(MAX) NULL;

--delete from DocumentVerification where VerificationID = 12;

UPDATE DocumentVerification
SET DocumentStatus = 'Pending'
WHERE VerificationID = 16;
...
ADD IsActive BIT DEFAULT 1; -- 1 for Active, 0 for Inactive
...
UPDATE Products
SET ImageURL = 'https://whvn.cc/jxwzeq'
