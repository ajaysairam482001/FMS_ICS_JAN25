...
namespace FMS_Server2.Models
{
    ...
    public partial class fms_db_ics2Entities : DbContext
    {
        public fms_db_ics2Entities()
            : base("name=fms_db_ics2Entities")
        {
        ...
        public virtual DbSet<DocumentVerification> DocumentVerification { get; set; }
